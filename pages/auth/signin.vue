<template>
  <v-row align="center" justify="center">
    <v-col cols="12" sm="8" md="4" align="center">
      <v-card width="500" class="elevation-4 align-content-center" color="">
        <v-card-title class="text-center justify-center">Login to Barona OMS</v-card-title>
        ...
        <v-list-item @click="forward" class="text-decoration-underline">
          <v-list-item-content>
            <v-list-item-title align="center"
              >Not a Use: Register here
            </v-list-item-title>
          </v-list-item-content>
        </v-list-item>
      </v-card>
